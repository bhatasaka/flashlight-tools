...
///////// Variables
main_diameter = 16.95; // mm - diameter of big cylinder cutout
cone_wider_diameter = main_diameter + 1.75;
wing_radius = 1.6; // mm - radius of smaller cylinders
wing_offset = (main_diameter / 2) - (0.32 * wing_radius); // offset inward slightly
main_height = 3.5; // mm - height of cylinder and wings
...
translate([0, 0, grip_z_offset]) { // offset to make sure they form one object
    difference() {
        ...
        square_drive_cutout(grip_height+1);
    }
}
