// Fireflies Z1 Artemis Bezel Tool
// Version 1.1

$fn = 150;

///////// Variables
main_diameter = 19.95; // mm - diameter of big cylinder cutout
cone_wider_diameter = 22.28;
wing_diameter = 2.32; // mm - diameter of smaller cylinders
wing_offset = (main_diameter / 2) - (0.11 * wing_diameter); // offset inward slightly
main_height = 1.75; // mm - height of cylinder and wings
